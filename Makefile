...
tea: bin.build/JSHOP2.jar
	cd examples/tea; java JSHOP2.InternalDomain tea
	cd examples/tea; java JSHOP2.InternalDomain -ra problem
	cd examples/tea; javac gui.java
	cd examples/tea; java gui
	cd examples/tea; rm tea.java; rm tea.txt; rm tea.java; rm *.class
